  ...
  return (
    <div className="pt-32 pb-32 mx-auto max-w-7xl px-4 lg:px-12 text-center min-h-screen relative overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-4xl mx-auto z-10 flex flex-col pt-15">
            ...
            >
              ...
              <div
                className={`absolute top-0 transform -translate-y-1/2 -translate-x-1/2
                    ...
                    left-[2.5rem] ${isLeft ? "md:left-[25%]" : "md:left-[75%]"}`}
              >
                {status === "past" && (
              ...
              <div
                className={`absolute top-0 z-30 w-[calc(100%-5rem)] md:w-[340px] 
                left-[4.5rem] -translate-y-1/2 md:left-[25%] md:-translate-x-1/2 md:-translate-y-[115%]
                ${!isLeft && "md:left-[75%]"}
              `}
              >
                <div
                ...
                >
                  <div
                    className={`bg-[#090909] border-[2px] ${borderClass} rounded-xl p-4 md:p-5 shadow-2xl relative flex flex-col backdrop-blur-md transition-all duration-300 hover:scale-[1.02]`}
                  >
                    <div
                      className={`hidden md:block absolute -bottom-[7px] left-1/2 -translate-x-1/2 w-3 h-3 rotate-45 bg-[#1A1E23] border-b-[2px] border-r-[2px] ${pointerClass}`}
                    />
                    <div
                      className={`md:hidden absolute top-1/2 -translate-y-1/2 -left-[7px] w-3 h-3 rotate-45 bg-[#1A1E23] border-b-[2px] border-l-[2px] ${pointerClass}`}
                    />
                    ...
                    <div className="space-y-2 mb-4 text-left">
                      ...
                      <div className="flex items-start gap-4">
                        <span className="text-[#F97316]/60 text-xs font-medium tracking-[0.18em] w-12 uppercase tracking-wider shrink-0 mt-0.5">
                          Loc
                        </span>
        ...
        <div className="relative w-full h-80 md:h-72 mt-[-2px]">
          {/* Desktop Track */}
          ...
          <div className="absolute top-[50%] md:top-[65%] z-30 w-[calc(100%-3rem)] md:w-[420px] left-1/2 -translate-y-1/2 -translate-x-1/2">
            <div className="absolute left-1/2 -translate-x-1/2 -top-[188px] md:-top-[198px] w-full flex justify-center pointer-events-none z-50">
              <svg
                width="270"
                height="200"
                viewBox="0 0 240 160"
